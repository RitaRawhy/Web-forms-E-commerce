<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Muscle-building.aspx.cs" Inherits="Muscle_building" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class ="type"><h3>Here you can gain  muscles more than you think </h3> </div>
 ...
 <asp:DataList ID="Datalist1" runat="server"
    ...
    <asp:SqlDataSource ID="SqlDataSource1"   runat="server" 
        ...
        SelectCommand="SELECT [product_name], [price] , [pimage] , [product_id] FROM [products] WHERE category = 'MUSCLE BUILDING'" >  
    </asp:SqlDataSource>
