...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class ="type"><h3>Some equipments you may need and nice outfits </h3> </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [product_name], [price] , [pimage] , [product_id] FROM [products] WHERE category = 'ACCESSORIES'" >      
    </asp:SqlDataSource>
