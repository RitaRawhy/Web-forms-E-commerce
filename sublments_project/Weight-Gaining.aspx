<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Weight-Gaining.aspx.cs" Inherits="Weight_Gaining" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class ="type"><h3>you don't have any execuse to be skinny </h3> </div>
  ...
  <asp:DataList ID="Datalist1" runat="server"
    ...
    <asp:SqlDataSource ID="SqlDataSource1"   runat="server" 
        ...
        SelectCommand="SELECT [product_name], [price] , [pimage] , [product_id] FROM [products] WHERE category = 'Weight Gaining'" >      
    </asp:SqlDataSource>
</asp:Content>
